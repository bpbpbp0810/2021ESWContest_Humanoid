...
s_max =     [255,255,223,110,255,255,178,178,178,178]
s_min =     [ 188,164,150, 51,133,134, 51, 51, 51, 51]
    
v_max =     [198,255,239,156,255,253,236,236,236,236]
v_min =     [91,129,104, 61,104, 84, 22, 22, 22, 22]
...
def main():
    ...
    cv2.namedWindow(Top_name, cv2.WINDOW_NORMAL)
