...
class Search():
    ...
    def __init__(self, BPS, W_View_size, H_View_size):
        ...
        self.yuv_Lower = np.array([[40,100,20],[30,12,46],[65,104,104]])
        self.yuv_Upper = np.array([[180,190,110],[126,120,135],[100,239,255]])
    ...
    def yellow_line(self, View_select_y, operate):
        ...
        elif slope_another == 254:                            #if we detect horizontal line
            self.slope_yellow = 254                         #then slope_yellow is 255
            slope_another = 0

        elif slope_another == 253:                            #if we detect horizontal line
