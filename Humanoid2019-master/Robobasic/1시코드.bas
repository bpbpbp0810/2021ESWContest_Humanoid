...
곡선전진종종걸음4_3:
    ...
    ELSEIF A = 153 THEN
        GOTO 곡선전진종종걸음작은우회전4_3멈춤
        '곡선방향 = 3
    ELSEIF A = 103 THEN
        ' 곡선방향 = 1
        GOTO 곡선전진종종걸음작은좌회전4_3멈춤
    ELSEIF A = 128 THEN
        곡선방향 = 2
    ELSEIF A = 150 THEN
        GOTO 곡선전진종종걸음좌4_3멈춤
...
곡선전진종종걸음4_6:
    ...
    ELSEIF A = 153 THEN
        '곡선방향 = 3
        GOTO 곡선전진종종걸음작은우회전4_6멈춤
    ELSEIF A = 103 THEN
        '곡선방향 = 1
        GOTO 곡선전진종종걸음작은좌회전4_6멈춤
    ELSEIF A = 128 THEN
        곡선방향 = 2
    ELSEIF A = 150 THEN
        GOTO 곡선전진종종걸음좌4_6멈춤
...
mm좌우앞뒤:
    ...
    IF A=0 THEN
    	...
    	IF ff>5 THEN
         ...
         ENDIF
    ELSEIF A=128 THEN
        IF 적외선거리값 <160 AND 적외선거리값>105 THEN
            GOSUB final2
			GOTO mm좌우앞뒤
        ELSEIF 적외선거리값<105 THEN 'far
        
            GOSUB 고개들고_한발앞으로가기
            'GOSUB 적외선거리센서확인

        ELSEIF 적외선거리값>160 THEN 'CLOSE
            GOSUB 고개들고_한발뒤로가기
            'GOSUB 적외선거리센서확인
        ELSE
            GOSUB m고개들고_한발앞으로가기
