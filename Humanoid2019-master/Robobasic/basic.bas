...
전진달리기150:
    ...
    MOVE G6A,97,  79, 135,  104, 101
    MOVE G6D,99,  79, 135,  104, 101
    WAIT

    MOVE G6A,96,  81, 125,  115, 101
    MOVE G6D,100,  82, 125,  115, 101
    WAIT

    MOVE G6A,95,  84, 115,  126, 101
    MOVE G6D,101,  85, 115,  126, 98
    WAIT
    ...
    IF 보행순서 = 0 THEN
        ...
        MOVE G6A,95,  88, 90, 153, 104
        MOVE G6D,104,  85, 123,  117,  102
        MOVE G6B, 80
        MOVE G6C,120
        WAIT
    ...
    ELSE
        보행순서 = 0
        MOVE G6D,95,  84, 115,  126, 101
        MOVE G6A,101,  85, 115,  126, 98
        WAIT

        MOVE G6D,95,  88, 90, 153, 104
        MOVE G6A,104,  85, 118,  122,  102
        MOVE G6C, 80
        MOVE G6B,120
        WAIT
...
전진달리기150_1:
    MOVE G6A,95,  103, 70, 153, 104
    MOVE G6D,104,  85, 117,  126,  102
    MOVE G6B, 80
    MOVE G6C,120
    WAIT
...
전진달리기150_2:
    MOVE G6A,95,  83, 92, 153, 104
    MOVE G6D,104,  86, 117,  123,  100
    WAIT

전진달리기150_3:
    MOVE G6A,103,  77, 115, 136,  100
    MOVE G6D, 95, 95, 130,  101, 102
    WAIT
    ...
    ERX 4800,A, 전진달리기150_4
    IF A <> A_old THEN
전진달리기150_3_stop:

        MOVE G6D,90,  101, 85, 133, 104
        MOVE G6A,104,  82, 115,  124,  102
        MOVE G6C, 100
        MOVE G6B,100
        WAIT
        HIGHSPEED SETOFF
...
전진달리기150_4:
    MOVE G6D,95,  103, 70, 152, 104
    MOVE G6A,104,  85, 117,  126,  102
    MOVE G6C, 80
    MOVE G6B,120
    WAIT
...
전진달리기150_5:
    MOVE G6D,95,  83, 92, 153, 104
    MOVE G6A,104,  86, 117,  123,  100
    WAIT


전진달리기150_6:
    MOVE G6D,103,  77, 115, 136,  100
    MOVE G6A, 95, 95, 130,  101, 102
    WAIT
    ...
    ERX 4800,A, 전진달리기150_1
    IF A <> A_old THEN
전진달리기150_6_stop:

        MOVE G6A,90,  101, 85, 133, 104
        MOVE G6D,104,  82, 115,  124,  102
        MOVE G6B, 100
        MOVE G6C,100
        WAIT
        HIGHSPEED SETOFF
...
전진달리기50:
    ...
    IF 보행순서 = 0 THEN
        보행순서 = 1
        MOVE G6A,95,  76, 145,  96, 101
        MOVE G6D,101,  77, 145,  96, 98
        WAIT

        MOVE G6A,95,  80, 120, 123, 104
        MOVE G6D,104,  77, 146,  94,  102
        MOVE G6B, 80
        MOVE G6C,120
        WAIT
    ...
    ELSE
        보행순서 = 0
        MOVE G6D,95,  76, 145,  96, 101
        MOVE G6A,101,  77, 145,  96, 98
        WAIT

        MOVE G6D,95,  80, 120, 123, 104
        MOVE G6A,104,  77, 146,  94,  102
        MOVE G6C, 80
        MOVE G6B,120
        WAIT
...
전진달리기50_1:
    MOVE G6A,95,  95, 100, 123, 104
    MOVE G6D,104,  77, 147,  96,  102
    MOVE G6B, 80
    MOVE G6C,120
    WAIT
...
전진달리기50_2:
    MOVE G6A,95,  75, 122, 123, 104
    MOVE G6D,104,  78, 147,  93,  100
    WAIT

전진달리기50_3:
    MOVE G6A,103,  69, 145, 106,  100
    MOVE G6D, 95, 87, 160,  71, 102
    WAIT
...
전진달리기50_3_stop:
        ...
        MOVE G6D,90,  93, 115, 103, 104
        MOVE G6A,104,  74, 145,  94,  102
        MOVE G6C, 100
        MOVE G6B,100
        WAIT
        HIGHSPEED SETOFF
...
전진달리기50_4:
    MOVE G6D,95,  95, 100, 123, 104
    MOVE G6A,104,  77, 147,  96,  102
    MOVE G6C, 80
    MOVE G6B,120
    WAIT
...
전진달리기50_5:
    MOVE G6D,95,  75, 122, 123, 104
    MOVE G6A,104,  78, 147,  93,  100
    WAIT


전진달리기50_6:
    MOVE G6D,103,  69, 145, 106,  100
    MOVE G6A, 95, 87, 160,  71, 102
    WAIT
...
전진달리기50_6_stop:
        ...
        MOVE G6A,90,  93, 115, 103, 104
        MOVE G6D,104,  74, 145,  94,  102
        MOVE G6B, 100
        MOVE G6C,100
        WAIT
        HIGHSPEED SETOFF
...
진행코드_1:
    ERX 4800, A
    IF A=101 THEN GOTO 전진종종걸음
    ELSE IF A=102 THEN GOTO 안정화자세
    ELSE IF A=103 THEN GOTO
    ELSE IF A=111 THEN GOTO 왼쪽턴20
    ELSE IF A=112 THEN GOTO 왼쪽턴45
    ELSE IF A=113 THEN GOTO 왼쪽옆으로20
    ELSE IF A=121 THEN GOTO 오른쪽턴20
    ELSE IF A=122 THEN GOTO 오른쪽턴45
    ELSE IF A=123 THEN GOTO 오른쪽옆으로20
ENDIF
